            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, , 6, 8]);
                        _loop_1 = function () {
                            var _b, task, cancelTask, runProps;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0: return [4 /*yield*/, (0, effects_1.take)(channel)];
                                    case 1:
                                        _b = (_c.sent()).payload, task = _b.task, cancelTask = _b.cancelTask, runProps = _b.runProps;
                                        return [4 /*yield*/, (0, effects_1.fork)(function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        ...
                                                        case 1:
                                                            runningTask = _a.sent();
                                                            return [4 /*yield*/, (0, effects_1.call)(cancelTask)];
                                                        case 2:
                                                            _a.sent();
