...
export declare class RSFiniteStateMachineEngine {
    private props;
    private emitter;
    static runStateMachine<ERSFiniteStateMachineState extends string | number | symbol = string, ReduxStoreState = undefined, RunProps = undefined>(stateMachine: RSFiniteStateMachine<ERSFiniteStateMachineState, ReduxStoreState, RunProps>, options?: IRSFiniteStateMachineEngineRunMachineOptions<RunProps>): (action: Action) => Generator<import("redux-saga/effects").TakeEffect | import("redux-saga/effects").CancelEffect | import("redux-saga/effects").ForkEffect<void>, void, Task<any>>;
    ...
    runMachineWithProps<ERSFiniteStateMachineState extends string | number | symbol = string, ReduxStoreState = undefined, RunProps = undefined>(stateMachine: RSFiniteStateMachine<ERSFiniteStateMachineState, ReduxStoreState, RunProps>, runProps?: RunProps): () => void;
    destroy(): void;
