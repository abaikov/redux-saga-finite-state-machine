...
export declare class RSFiniteStateMachineEngine {
    ...
    runStateMachine<ERSFiniteStateMachineState extends string | number | symbol = string, ReduxStoreState = undefined, RunProps = {}>(stateMachine: RSFiniteStateMachine<ERSFiniteStateMachineState, ReduxStoreState, RunProps>, options?: IRSFiniteStateMachineEngineRunMachineOptions<RunProps>): (action: Action) => Generator<import("redux-saga/effects").TakeEffect | import("redux-saga/effects").CancelEffect | import("redux-saga/effects").CallEffect<unknown> | import("redux-saga/effects").ForkEffect<void>, void, Task<any>>;
